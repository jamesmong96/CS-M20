<?php
    ...
    $sql = $conn->prepare("SELECT * from records ORDER BY id DESC LIMIT 100;");
    $sql->execute();
                                ...
                                <?php 
                                    ...
                                    if ($result->num_rows > 0) {
                                        while($row = $result->fetch_assoc()) {
                                            echo "<tr>";
                                            echo "  <td>".$row["time"]."</td>";
                                            if ($row["attempt"] == "success") {
                                                echo "  <td class='table-success text-success'><strong>".$row["attempt"]."</strong></td>";
                                            } else {
