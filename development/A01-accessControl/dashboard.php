            ...
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        ...
                        <!-- The below session only display to "Admin" role users -->
                        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted text-uppercase">
                            <span>Admin functions <?php if ($role != "Admin") {echo "(Unavailable for users)";} ?></span>
                        </h6>
                        <ul class="nav flex-column mb-2" id="admin_functions" <?php if ($role != "Admin") {echo "hidden";} ?>>
                            <li class="nav-item">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Reset admin password</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <span id="message">Do you sure you want to reset admin password?</span>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="confirm" onclick="document.getElementById('message').innerHTML = 'Successfully reset password!'; document.getElementById('confirm').style.visibility = 'hidden';">Confirm</button>
